...
- [x] D39 Windows hook 注册 sh 兼容形态（第 1 轮 ps1 桥加 M062；第 2 轮幂等漏清扫加 M063；第 3 轮 codex review F1 至 F6 全收：head 补 .exe、doctor 判形 program_token、ps1 字节读与事件映射对齐、清扫外科摘键、包裹分支收窄）
